...
<div class="container mt-4">
    ...
    <ul class="nav nav-pills mb-4">
        ...
        <li class="nav-item"><a class="nav-link active" href="pengurusan.php">Pengurusan</a></li>
    </ul>
    ...
    <div class="card mb-3">
        <div class="card-body">
            <p class="mb-0">Klik tombol di bawah untuk memproses semua data daftar ulang yang sudah memiliki No. Antrian (Keterangan = OK) menjadi data pengurusan berkas.</p>
            <a href="proses/proses_pengurusan.php" class="btn btn-primary mt-2">Proses Semua Antrian Baru</a>
        </div>
    </div>

    <div class="card">
        <div class="card-header">Data Pengurusan Paspor</div>
        <div class="card-body table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $result = $conn->query("SELECT * FROM pengurusan ORDER BY no_antrian ASC");
                $total_pendapatan = 0;
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                        ...
                        <td>" . htmlspecialchars($row['berkas']) . "</td>
            ...
            <div class="mt-3">
                <h5>Pendapatan: Rp <?= number_format($total_pendapatan, 0, ',', '.') ?></h5>
            </div>
        </div>
    </div>
